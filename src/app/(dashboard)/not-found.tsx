...
/** 404 dentro del área autenticada: se renderiza dentro de `(dashboard)/layout.tsx`, conserva el header/sidebar. */
  ...
  return (
    <div className="mx-auto flex max-w-md flex-col items-center px-6 py-24 text-center">
      ...
      <p className="mt-2 text-sm text-muted">
        Revisa la dirección o vuelve al panel — puede que el enlace esté roto o que la página se haya movido.
      </p>
      <Link
