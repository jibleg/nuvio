...
import { refacturarAction } from "../actions";
        ...
        <div className="bg-linear-to-br from-brand-600 to-brand-800 px-6 py-7">
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0 pr-10">
              <p className="font-display text-lg font-bold text-white">Refacturar</p>
              <p className="mt-0.5 text-sm text-white/75">Corrige esta factura con un CFDI sustituto</p>
            </div>
          </div>
    ...
    >
      <div className="space-y-4">
        <p className="text-sm text-ink">
          Se creará un borrador sustituto ligado a esta factura (CFDI relacionado). Al timbrarlo, podrás cancelar esta con el motivo de sustitución.
        </p>
          ...
          <button
            ...
            onClick={() => {
              ...
              startTransition(async () => {
                const result = await refacturarAction(idFactura);
                if (!result.ok) {
